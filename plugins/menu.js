 ...
 *Powered By @${"16199961931".split("@")[0]}*`;
  ...
  let tksk = `${pe}${ucapan()}, @${m.sender.split`@`[0]} ${pickRandom([
    "😅",
    "🥰",
    "😜",
  ])}${pe}
  ...
  const sections = [
    {
      rows: [
        ...
        },
        {
          ...
          description:
            "Gabung untuk mendapatkan informasi mengenai bot atau sekedar meramaikan",
          rowId: ".gcbot",
        },
      ],
      title: "▮Status 」",
    ...
    },
    {
      rows: [
        ...
        },
        {
          ...
          description:
            "Especially WhatsApp users whose numbers start with +212",
          rowId: ".QnA",
        },
        {
          title: "☎️ ∫  Kata penutup ",
          description:
            "Terimakasih untuk user yang telah menggunakan bot, jika ada kesalahan atau permintaan bisa chat ke nomor owner\nNote: chat P/main² tidak akan di respon(user bisa terkena banned/block)",
          rowId: ".creator",
        },
      ],
      title: "▮Info Lainnya 」",
      ...
      rows: [
        {
          title: "🥇「 Contributor 」",
          description:
            "Terima kasih banyak untuk user yang telah berpartisipasi",
          rowId: ".? thnks",
        },
      ],
      title: "▮Thanks To  」",
